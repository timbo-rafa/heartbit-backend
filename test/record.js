...
describe('record controller', function () {
  ...
  describe('create', function (done) {
    ...
    it('should raise error without required fields', function (done) {
      ...
      request = request.post('/patients/1/records')
      request.send({})
      request.expect(400)
  ...
  describe('list all', function (done) {
    it('should list all records', function (done) {
      var request = supertest(app)
      request = request.get('/patients/1/records')
      request.expect(200)
  ...
  describe('details', function (done) {
    it('should raise error with invalid id', function (done) {
      var request = supertest(app)
      request = request.get('/patients/1/records/invalid')
      request.expect(404)
      request.end(done)
    })
    ...
    it('should show details with valid id', function (done) {
      var request = supertest(app)
      request = request.get('/patients/1/records/1')
      request.expect(200)
      request.expect(function (res) {
        res.body.should.equal({})
      })
  ...
  describe('delete', function (done) {
    it('should raise error with invalid id', function (done) {
      var request = supertest(app)
      request = request.del('/patients/1/records/invalid')
      request.expect(404)
      request.end(done)
    })
    ...
    it('should delete with valid id', function (done) {
      var request = supertest(app)
      request = request.del('/patients/1/records/1')
      request.expect(204)
      request.end(done)
    })
  })
